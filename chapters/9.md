...
<table>
<tr>
    <td>material _material_id_: _parent_material_id_</td><td></td><td></td>
</tr>
<tr>
    <td>{</td><td></td><td></td>
</tr>
<tr>
    <td>uniform_name = scalar | vector</td>
    <td>[0..*]</td>
    <td>uniform</td>
</tr>
<tr>
    <td>uniform_name = AUTO_BIND_ENUM</td>
    <td>[0..*]</td>
    <td>enum</td>
</tr>
<tr>
...
pass pass_id	 	 
{	 	 
  vertexShader = res/colored.vert	required	file path
  fragmentShader = res/colored.frag	required	file path
...
{	 	 
  ...
  cullFaceSide = CULL_FACE_SIDE_BACK	[0..1]	enum
